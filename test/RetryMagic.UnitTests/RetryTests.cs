    ...
    public class RetryTests
    {
        ...
        public class FunctionMethod
        {
            ...
            public void Throws_RetryException_If_Function_Fails_For_Maximum_Attempts()
            {
                ...
                // act + assert
                Assert.Throws<RetryException>(() => Retry.Function(functionToTryMock.Object));
            ...
            public void Throws_RetryException_With_Each_Thrown_Exception_As_Inner_Exception_If_Function_Fails_For_Maximum_Attempts()
            {
                ...
                // act + assert
                var retryException = Assert.Throws<RetryException>(() => Retry.Function(functionToTryMock.Object));
        ...
        public class ActionMethod
        {
            ...
            public void Throws_RetryException_If_Function_Fails_For_Maximum_Attempts()
            {
                ...
                // act + assert
                Assert.Throws<RetryException>(() => Retry.Action(actionToTryMock.Object));
            ...
            public void Throws_RetryException_With_Each_Thrown_Exception_As_Inner_Exception_If_Function_Fails_For_Maximum_Attempts()
            {
                ...
                // act + assert
                var retryException = Assert.Throws<RetryException>(() => Retry.Action(actionToTryMock.Object));
